...
public class Stringa {
    public static void main(String[] args) {
        ...
        res = a1.concat(a2).concat(a3).concat(a4); //best practice
        System.out.println(res + " It`s really cool!");

        a1 = "Serhii the best tester in the world!";
        String[] arnew = a1.split(" ");
        System.out.println(arnew[arnew.length - 1]); //world!
